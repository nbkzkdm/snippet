...
public class Diff {
     ...
     */
    public static <T> boolean diff(Class<T> clazz, T elem1, T elem2) throws HolidayException {
     ...
     * @throws HolidayException
     */
    public static <T> boolean diff(Class<T> clazz, T elem1, T elem2, List<String> ignoreFieldList) throws HolidayException {
     ...
     * @throws HolidayException
     */
    private static <T> Object getValue(T elem, Method readMethod) throws HolidayException {
        try {
            return readMethod.invoke(elem, (Object[]) null);
        }
        catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
            log.error(e.getMessage(), e);
            throw new HolidayException(ErrorType.INVOKE, e);
        }
    }
     ...
     * @throws HolidayException
     */
    private static <T> PropertyDescriptor getPropertyDescriptor(Class<T> clazz, Field field) throws HolidayException {
        try {
            return new PropertyDescriptor(field.getName(), clazz);
        }
        catch (IntrospectionException e) {
            log.error(e.getMessage(), e);
            throw new HolidayException(ErrorType.INTROSPECTION, e);
        }
    }
